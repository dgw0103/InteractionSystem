...
1. Make an [Issue](https://github.com/dgw0103/interactionsystem/issues/new)
...
```json
    {
        "dependencies": {
            "com.dgw0103.interactionsystem": "https://github.com/YOUR_USER/interactionsystem.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at dgw0103@naver.com.
